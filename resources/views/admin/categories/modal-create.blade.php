                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="menu_id" id="menu-parent">
                            ...
                            @foreach ($menus as $menu)
                                <option value="{{$menu->id}}" class="from-control" data-url="/admin/category/parent-menu/{{$menu->id}}">{{$menu->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="parent_id">Category Parent</label>
                        <select class="custom-select" name="parent_id" id="default-parent-category">
                            <option value="0" class="from-control">Default</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-primary btn-sm" id="btn-category-create" disabled="true"><i class="fas fa-paper-plane"></i> Save</button>
                    </div>
                </form>
            </div>
