<a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target=".edit-category-child-{{$child->id}}">
    <i class="fas fa-edit"></i>
</a>

<div class="modal fade edit-category-child-{{$child->id}}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Category {{$child->name}} ?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" action="/admin/category/{{$child->id}}/update">
                    {{csrf_field()}}
